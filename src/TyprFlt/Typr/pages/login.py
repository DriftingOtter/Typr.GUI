...
class Login(ft.UserControl):
    ...
    def initialize_page_controls(self):
        ...
        self.login_btn = ft.ElevatedButton("Login", on_click=self.login_event)
        ...
        self.login_frame = ft.ListView(
            controls=[
                ...
                self.create_column([ft.Container(padding=5), self.login_btn, self.signup_btn]),
            ]
        )
    ...
    def login_event(self, e):
        ...
        self.return_value = self.login_manager.authenticate_user(self.email, self.pwd)
